...
void clipping(double x0, double y0, double x1, double y1)
{
	...
	int accept = 0, ok = 0;// These are two bits to indicate trivial accept and/or
							 // ok with clipping
							 //compute outcodes
...
void display()
{
	...
	glColor3f(0.0, 0.0, 0.0); // draw red color lines
	glBegin(GL_LINES);
	glVertex2d(x0, y0);
	glVertex2d(x1, y1);
	glVertex2d(60, 20);
	glVertex2d(80, 120);
	glEnd();
	glColor3f(0.0, 0.0, 0.0); // draw a blue colored window
	glBegin(GL_LINE_LOOP);
